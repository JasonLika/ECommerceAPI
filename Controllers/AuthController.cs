...
namespace ProductAPI.Controllers
{
    ...
    public class AuthController : ControllerBase
    {
        ...
        public IActionResult Login()
        {
            ...
            var redirectUri = Uri.EscapeDataString("https://localhost:7117/auth/callback");
        ...
        public async Task<IActionResult> Callback([FromQuery] string code, [FromQuery] string state)
        {
            ...
            if (userProfile == null)
            {
                ...
                string role = githubUser.login.Equals("JasonLika", StringComparison.OrdinalIgnoreCase)
                    ? "administrator"
                    : "customer";
            ...
            var claims = new List<Claim>
    {
        ...
        new Claim(ClaimTypes.Role, userProfile.Role)
            ...
            var redirectUrl = $"https://localhost:7001/tokenreceiver?token={jwtToken}&newUser={isNewUser}";
